...
CHAPTERS = [
    ...
    {"name": "Scenario frameworks", "start": 9, "end": 15, "minutes": 15},
    {"name": "Read the pathways", "start": 16, "end": 22, "minutes": 18},
    {"name": "From IAM to Premise", "start": 23, "end": 24, "minutes": 8},
    {"name": "LCIA and interpretation", "start": 25, "end": 29, "minutes": 11},
    {"name": "Build and report", "start": 30, "end": 32, "minutes": 7},
